...
public class TestNg_real_time_example {
	  ...
	  public WebDriver driver;
	    ...
	    public void checkLogin()
	    {
	          ...
	          driver.findElement(By.name("email")).sendKeys("ashwinimunde4793@gmail.com");
	          driver.findElement(By.name("pass")).sendKeys("Aekansh*1110");
